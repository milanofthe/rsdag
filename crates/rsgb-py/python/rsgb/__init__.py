"""rsgb: trace Python functions into a symbolic graph, differentiate, compile.

    from rsgb import jit, jacobian, grad
...
is not traceable; use `rsgb.where(cond, a, b)`.
"""

import numpy as np

from ._rsgb import Program, Scope, Tracer, select as _select
...
class Compiled:
    ...
    def c_source(self, *args, name="rsgb_fn"):
